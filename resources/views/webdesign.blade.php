...
<body>
            <div class="card">
                <div class="card-body">
                  <a href="{{ route('tambah') }}" class="btn btn-primary">Tambah Category</a>
                </div>
              </div>
           ...
           <div class="col">
               <div class="card">
                   <div class="card-body">
                     ...
                     <a href="#" class="btn btn-primary">bisnis</a>
                     <a href="{{ route('tambah') }}" class="btn btn-warning">edit Category</a>
                   </div>
                 </div>
           </div>
           <div class="col">
               <div class="card">
                   <div class="card-body">
                     <h5 class="card-title">web olshop</h5>
                     <p class="card-text">p</p>
                     <a href="#" class="btn btn-primary">olshop</a>
                     <a href="{{ route('edit') }}" class="btn btn-warning">edit Category</a>
                   </div>
                 </div>
